...
public class EmployeeApp extends javax.swing.JFrame {
    ...
    public EmployeeApp() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this.getContentPane(), "Could not establish a connection with a server", "Connection error", JOptionPane.ERROR_MESSAGE);
        }
        populateTable();
    }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (jTable2.getSelectedRow() != -1) {
            DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
            try {
                r.deleteEmployeeById(Integer.parseInt(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString()));
            } catch (SQLException ex) {
                ex.printStackTrace();
            }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            r.updateEmployeeById(e, Integer.parseInt(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString()));
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    ...
    private void tfSearchIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchIdKeyReleased
        ...
        try {
            Employee em = r.searchById(Integer.parseInt(tfSearchId.getText()));
            if (em != null) {
                model.addRow(new Object[]{em.getId(), em.getName(), em.getAge(), em.getAddress(), em.getSalary()});
            } else {
            ...
            System.out.println("Not a number, but keep going");
        }
    ...
    private void tfSearchNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchNameKeyReleased
        ...
        List<Employee> employee;
        try {
            employee = r.searchByName(tfSearchName.getText());
            for (Employee em : employee) {
                model.addRow(new Object[]{em.getId(), em.getName(), em.getAge(), em.getAddress(), em.getSalary()});
            }
        } catch (SQLException ex) {
    ...
    private void tfSearchAgeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchAgeKeyReleased
        ...
        List<Employee> employee;
        try {
            employee = r.searchByAge(Integer.parseInt(tfSearchAge.getText()));
            for (Employee em : employee) {
                model.addRow(new Object[]{em.getId(), em.getName(), em.getAge(), em.getAddress(), em.getSalary()});
            }
        } catch (SQLException ex) {
    ...
    private void tfSearchAddressKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchAddressKeyReleased
        ...
        List<Employee> employee;
        try {
            employee = r.searchByAddress(tfSearchAddress.getText());
            for (Employee em : employee) {
                model.addRow(new Object[]{em.getId(), em.getName(), em.getAge(), em.getAddress(), em.getSalary()});
            }
        } catch (SQLException ex) {
    ...
    private void tfSearchSalaryKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchSalaryKeyReleased
        ...
        List<Employee> employee;
        try {
            employee = r.searchBySalary(Double.parseDouble(tfSearchSalary.getText()));
            for (Employee em : employee) {
                model.addRow(new Object[]{em.getId(), em.getName(), em.getAge(), em.getAddress(), em.getSalary()});
            }
        } catch (SQLException ex) {
